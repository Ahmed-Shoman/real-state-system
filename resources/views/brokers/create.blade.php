...
@section('title', 'إضافة سمسار')
@section('page-title', 'إضافة سمسار جديد')
@section('page-subtitle', 'أدخل بيانات السمسار الجديد')

@section('header-actions')
    <a href="{{ route('brokers.index') }}"
       class="inline-flex items-center gap-2 text-sm text-slate-600 bg-white border border-slate-200 px-4 py-2 rounded-xl transition-colors hover:bg-slate-50">
...
<div class="max-w-2xl">
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
        <form action="{{ route('brokers.store') }}" method="POST" novalidate>
            @csrf
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="الاسم الكامل"
                ...
                <div>
                    ...
                    <input type="text" id="phone" name="phone" value="{{ old('phone') }}" placeholder="01xxxxxxxxx"
                ...
                <div>
                    ...
                    <input type="text" id="office_name" name="office_name" value="{{ old('office_name') }}" placeholder="مكتب النيل العقاري"
                ...
                <div>
                    ...
                    <input type="text" id="area" name="area" value="{{ old('area') }}" placeholder="مدينة نصر"
                        class="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:border-amber-400 focus:ring-amber-100">
                </div>
