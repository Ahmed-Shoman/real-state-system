...
@section('title', 'إضافة مالك')
@section('page-title', 'إضافة مالك جديد')
@section('page-subtitle', 'أدخل بيانات المالك الجديد')
        ...
        <form action="{{ route('owners.store') }}" method="POST" novalidate>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" id="whatsapp" name="whatsapp" value="{{ old('whatsapp') }}" placeholder="01xxxxxxxxx"
                ...
                <div>
                    ...
                    <input type="text" id="national_id" name="national_id" value="{{ old('national_id') }}" placeholder="14 رقم"
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea id="notes" name="notes" rows="3" placeholder="أي ملاحظات إضافية..."
                        class="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:border-amber-400 focus:ring-amber-100 resize-none">{{ old('notes') }}</textarea>
                </div>
